...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    showOnBlog: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
...
export interface ApiBranchBranch extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0424\u0438\u043B\u0438\u0430\u043B\u044B / \u0430\u0433\u0435\u043D\u0442\u044B \u043F\u043E \u0441\u0442\u0440\u0430\u043D\u0430\u043C';
    displayName: 'Branch';
    pluralName: 'branches';
    singularName: 'branch';
  };
...
export interface ApiCallRequestCallRequest extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0417\u0430\u044F\u0432\u043A\u0438 \u00AB\u043F\u0435\u0440\u0435\u0437\u0432\u043E\u043D\u0438\u0442\u0435 \u043C\u043D\u0435\u00BB';
...
export interface ApiCityCity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0413\u043E\u0440\u043E\u0434\u0430 (\u0441\u043F\u0440\u0430\u0432\u043E\u0447\u043D\u0438\u043A \u0434\u043B\u044F \u043F\u0440\u043E\u0433\u0440\u0430\u043C\u043C/\u0443\u043D\u0438\u0432\u0435\u0440\u0441\u0438\u0442\u0435\u0442\u043E\u0432/\u043F\u0440\u043E\u0436\u0438\u0432\u0430\u043D\u0438\u044F)';
    displayName: 'City';
    pluralName: 'cities';
    singularName: 'city';
  };
...
export interface ApiContactsPageContactsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    >;
    peoples: Schema.Attribute.Component<'shared.person', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  info: {
    description: '\u0421\u0430\u0439\u0442-wide \u043D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0438: \u043D\u0430\u0437\u0432\u0430\u043D\u0438\u0435, \u043A\u043E\u043D\u0442\u0430\u043A\u0442\u044B, \u0441\u043E\u0446\u0441\u0435\u0442\u0438';
    displayName: 'Global';
    pluralName: 'globals';
    singularName: 'global';
  };
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    socLinks: Schema.Attribute.Component<'shared.soc-links', false>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    contactInfo: Schema.Attribute.Component<'home.contact-info', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    homepageSteps: Schema.Attribute.Component<'home.step', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    >;
    ourServices: Schema.Attribute.Component<'home.service', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiLivingLiving extends Struct.CollectionTypeSchema {
  collectionName: 'livings';
  info: {
    description: '\u041F\u0440\u043E\u0436\u0438\u0432\u0430\u043D\u0438\u0435 (\u043E\u0431\u0449\u0435\u0436\u0438\u0442\u0438\u044F, \u043A\u0432\u0430\u0440\u0442\u0438\u0440\u044B)';
    displayName: 'Living';
    pluralName: 'livings';
    singularName: 'living';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    detailedPrices: Schema.Attribute.Component<'shared.text-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    image: Schema.Attribute.Media<'images'>;
    locale: Schema.Attribute.String;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::living.living'>;
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiMenuMenu extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u041C\u0435\u043D\u044E \u0441\u0430\u0439\u0442\u0430 (location: \u0448\u0430\u043F\u043A\u0430, \u0444\u0443\u0442\u0435\u0440\u044B, \u0441\u0430\u0439\u0434\u0431\u0430\u0440)';
    displayName: 'Menu';
    pluralName: 'menus';
    singularName: 'menu';
  };
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    items: Schema.Attribute.Component<'shared.menu-link', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    location: Schema.Attribute.Enumeration<
      ['menu_top', 'menu_footer_1', 'menu_footer_2', 'menu_footer_3', 'sidebar']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProgramProgram extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    include: Schema.Attribute.Component<'shared.parametr', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    includeBefore: Schema.Attribute.Component<'shared.text-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::program.program'
    >;
    notInclude: Schema.Attribute.Component<'shared.text-item', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    period: Schema.Attribute.Component<'shared.period', false>;
    price: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiQuestionnaireQuestionnaire
  ...
  info: {
    description: '\u0410\u043D\u043A\u0435\u0442\u0430 \u0441\u0442\u0443\u0434\u0435\u043D\u0442\u0430 (6 \u0448\u0430\u0433\u043E\u0432, \u0441\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u0430 \u0448\u0430\u0433\u043E\u0432 \u2014 JSON, 1:1 \u0441\u043E \u0441\u0442\u0430\u0440\u044B\u043C \u0441\u0430\u0439\u0442\u043E\u043C)';
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    step1: Schema.Attribute.JSON;
    step2: Schema.Attribute.JSON;
    step3: Schema.Attribute.JSON;
    step4: Schema.Attribute.JSON;
    step5: Schema.Attribute.JSON;
    step6: Schema.Attribute.JSON;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    confirm: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dateCourse: Schema.Attribute.String;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
      }>;
    globalStep: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    numberProfil: Schema.Attribute.Integer;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    phone: Schema.Attribute.String;
    price: Schema.Attribute.String;
    programm: Schema.Attribute.String;
    programmSelected: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    ...
    stepQuestionare: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<1>;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::living.living': ApiLivingLiving;
